...
def show_possible_matches(my_word,other_word,letters_guessed):
    ...
    for other_word in wordlist:
        if len(my_word) == len(other_word) and  match_with_gaps(my_word,other_word,letters_guessed) == True:
           
            new_list.append(other_word)
           
    for char in new_list:
        suggestions += char + ' '
        
    print('Possible words:',suggestions)    
    ...
    * After each guess, you should display to the user the 
    ...
    while guess != 0 or is_word_guessed(secret_word,letters_guessed) != True:
        ...
        if user_guess.isalpha()!= True or user_guess in letters_guessed:            
            ...
            show_possible_matches(my_word,other_word,letters_guessed)
    ...
    if guess == 0 :print('Sorry, you ran out of guesses. The word was else.')    
